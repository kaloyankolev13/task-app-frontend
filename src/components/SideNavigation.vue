<template>
  <aside v-if="isAuthenticated" class="w-64 h-screen bg-indigo-600 text-white fixed flex flex-col justify-between">
    <div>
    ...
    <button @click="userStore.logout" class="m-4 p-2 bg-red-500 hover:bg-red-700 text-white rounded">
      Log Out
    </button>
  </aside>
</template>
